...
You can turn an account on or off from the balance directly in Endless by double-clicking on it.
...
<DetailsBox title="What to do with credit cards?">
  ...
  <ul>
    ...
    <li>
      ...
      Endless doesn't have a neat solution for this situation yet. But you can use
      a couple of tricks.
    </li>
  </ul>
</DetailsBox>
...
And how would we save with paper envelopes? We would create a separate envelope for each goal: vacation, car, new phone, etc. Work with Endless in the same way. Create the necessary category and regularly set aside money there.

<DetailsBox title="How to hide a category in Zenmoney , but keep it in Endless?">
  <ol>
    <li> Create a category and check “Show in expenses”</li>
    <li> Assign a budget to it</li>
    <li> Uncheck “Show in expenses”</li>
  </ol>
  Now the category won't appear in Zenmoney 's expense categories but will be visible in Endless,
  because there is money in this “envelope”.
</DetailsBox>

### How to Account for Transfers?

All transfers outside the balance take money out of the budget. For example, transfers to a mortgage or investment account. Such transfers should be planned in advance, and Endless can do this.

Endless automatically creates categories for all accounts outside the balance. These categories will appear as soon as you make a transfer.
...
- After each paycheck, go to Endless and distribute unallocated money across categories.
- Periodically check that there is enough money in the categories. You can install Endless on your home screen directly from the browser.
- Move money from one category to another if needed. You can directly drag them from the “Available” column.
- Save and create new goals from the budget interface.
