...
<Head
  title="Personal Budgeting Rules | Endless"
...
Imagine envelopes you don't have to carry around: the balance of each envelope is visible in the app, and spent money is automatically deducted from the right one. Endless turns your categories from Zenmoney  into such envelopes:
...
<ExampleBox symbol="🎉">
  ...
  [set up Endless](/about/quick-start) →
</ExampleBox>
